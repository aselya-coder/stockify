...
<?php $__env->startSection('title', 'Konfirmasi Barang Masuk'); ?>
...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?php echo e(route('stok.masuk.confirm.update', $mutation->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\stockify\resources\views/stok/confirm-masuk.blade.php ENDPATH**/ ?>