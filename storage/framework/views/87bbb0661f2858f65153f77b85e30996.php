...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name', 'Stockify')); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div>
            ...
            <nav class="nav flex-column">
                ...
                <a href="<?php echo e(route('stok.index')); ?>" class="nav-link <?php echo e(request()->routeIs('stok.index') ? 'active' : ''); ?>">
        ...
        <div class="user-dropdown">
            <?php if(auth()->guard()->check()): ?>
                <button id="userButton" class="user-btn">
                    ...
                    <span class="text-truncate"><?php echo e(Auth::user()->name); ?></span>
                </button>
    ...
    <main class="main-content">
        ...
        <footer class="text-center text-gray-500 mt-10 border-top pt-3">
            © <?php echo e(date('Y')); ?> <span class="text-indigo-600 font-semibold">Stockify</span> — Sistem Manajemen Stok Barang Modern
        </footer>
    </main>
...
</html><?php /**PATH C:\laragon\www\stockify\resources\views/layouts/app.blade.php ENDPATH**/ ?>