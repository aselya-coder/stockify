            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold"><?php echo e($category->nama_kategori); ?></td>
                        <td class="text-muted"><?php echo e($category->deskripsi ?? '-'); ?></td>
                        <td class="text-center">
                            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|manager')): ?>
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('categories.edit', $category->id)); ?>" class="btn btn-sm btn-outline-warning" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="<?php echo e(route('categories.destroy', $category->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                        <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="4" class="text-center text-muted py-5">
                            ...
                            <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|manager')): ?>
                                <br>
                                <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-sm btn-primary mt-2">
